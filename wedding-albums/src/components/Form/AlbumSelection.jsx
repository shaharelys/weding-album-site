...
const albums = [
  {
    id: 'basic',
    name: 'אלבום פשוט',
    description: 'אלבום בסיסי ואיכותי במחיר משתלם במידות 30 x 30. מתאים לזוגות המחפשים פתרון נגיש עם שמירה על רמת איכות גבוהה.',
    basePrice: 499,
  ...
  },
  {
    id: 'linen',
    name: 'אלבום פשתן',
    description: 'עיצוב עכשווי עם כריכת פשתן טבעית במידות 30 x 30, דגש על מרחב וקומפוזיציה מינימליסטית. איכות הדפסה גבוהה במיוחד.',
    basePrice: 599,
  ...
  },
  {
    id: 'leather',
    name: 'אלבום עור',
    description: 'אלבום אלגנטי עשוי עור איכותי במידות 30 x 30 עם גימור מושלם. מתאים לזוגות המעדיפים מראה יוקרתי ועל-זמני.',
    basePrice: 649,
